...
void Madgwick::computeAngles()
{
	...
	// Angular velocity
	roll_vel = atan2f(qDot0*qDot1 + qDot2*qDot3, 0.5f - qDot1*qDot1 - qDot2*qDot2);
	pitch_vel = asinf(-2.0f * (qDot1*qDot3 - qDot0*qDot2));
	yaw_vel = atan2f(qDot1*qDot2 + qDot0*qDot3, 0.5f - qDot2*qDot2 - qDot3*qDot3);
